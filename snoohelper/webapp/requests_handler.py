...
class RequestsHandler:
    ...
    def handle_command(self, slack_request):
        ...
        if slack_request.command == '/user':
            ...
            response = snoohelper.utils.slack.SlackResponse("Command not available.")
    ...
    def handle_button(self, slack_request):
        ...
        if button_pressed == "summary":
            ...
            original_message = snoohelper.utils.slack.slackresponse_from_message(slack_request.original_message,
            ...
            try:
                ...
                new_button = snoohelper.utils.slack.SlackButton("Untrack", "untrack_" + target_user)
                replace_buttons = {'Track': new_button}

                response = snoohelper.utils.slack.slackresponse_from_message(slack_request.original_message,
                                                                             footer="Tracking user.",
                                                                             change_buttons=replace_buttons)
            except snoohelper.utils.exceptions.UserAlreadyTracked:
                response = snoohelper.utils.slack.SlackResponse()
            ...
            try:
                ...
                new_button = snoohelper.utils.slack.SlackButton("Track", "track_" + target_user)
                replace_buttons = {'Untrack': new_button}

                response = snoohelper.utils.slack.slackresponse_from_message(slack_request.original_message,
                                                                             footer="User untracked.",
                                                                             change_buttons=replace_buttons)
            except snoohelper.utils.exceptions.UserAlreadyUntracked:
                response = snoohelper.utils.slack.SlackResponse()
                response.add_attachment(text='Error: user is not being tracked', color='danger')
            ...
            try:
                ...
                new_button = snoohelper.utils.slack.SlackButton("Unbotban", "unbotban_" + target_user, style='danger')
            ...
            try:
                ...
                new_button = snoohelper.utils.slack.SlackButton("Botban", "botban_" + target_user, style='danger')
                replace_buttons = {'Unbotban': new_button}

                response = snoohelper.utils.slack.slackresponse_from_message(slack_request.original_message,
                                                                             footer="User unbotbanned.",
                                                                             change_buttons=replace_buttons)
            except snoohelper.utils.exceptions.UserAlreadyUnbotbanned:
                response = snoohelper.utils.slack.SlackResponse()
            ...
            response = snoohelper.utils.slack.SlackResponse("Button not functional.")
